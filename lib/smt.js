 ...
 */
function mergeobj(orgObj, appendObj) {
...
function httpfullbody(opt) {
    ...
    var proxyreq = http.request(opt, function(proxyres) {
        ...
        console.log('HEADERS: ' + returnHeaders);
    ...
    if (opt.sentQuery) proxyreq.write(sentQuery)
    proxyreq.end();
}



exports.httpfullbody=httpfullbody
